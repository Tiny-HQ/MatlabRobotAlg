...
% 定义 NURBS 曲线控制点和权重  Define NURBS curve control points and weights  
Px = [0 ;1;2;3;5;0 ;1;2;3;5;]; % 控制点坐标   Control point coordinates
W = [1 ;2;3;4;5;6 ;1 ;2;3;4;5;6 ]; % 权重  weight



  
% 定义 NURBS 曲线度数  Define the degrees of the NURBS curve  
k = 3; % 曲线度数  Define the degrees of the NURBS curve  
[m,n] = size(Px);
