...
syms mi_1 mi mi1 mi2 real;%质量;mass
...
syms Ii_1_xx Ii_1_xy Ii_1_xz Ii_1_yy Ii_1_yz Ii_1_zz real;%i-1轴惯量; i-1 axis inertia
syms Ii_xx Ii_xy Ii_xz Ii_yy Ii_yz Ii_zz real;%i轴惯量; i axis inertia
syms Ii1_xx Ii1_xy Ii1_xz Ii1_yy Ii1_yz Ii1_zz real;%i+1轴惯量;i+1 axis inertia
syms Ii2_xx Ii2_xy Ii2_xz Ii2_yy Ii2_yz Ii2_zz real;%i+2轴惯量; i+2 axis inertia

syms dqi_1_x dqi_1_y dqi_1_z ddqi_1_x ddqi_1_y ddqi_1_z real;%i-1轴角速度、角加速度; i-1 axis angular velocity, angular acceleration;
syms dqi_x dqi_y dqi_z ddqi_x ddqi_y ddqi_z real;%i轴角速度、角加速度; i axis angular velocity, angular acceleration;
syms dqi1_x dqi1_y dqi1_z ddqi1_x ddqi1_y ddqi1_z real;%i+1轴角速度、角加速度;i+1 axis angular velocity, angular acceleration;
syms dqi2_x dqi2_y dqi2_z ddqi2_x ddqi2_y ddqi2_z real;%i+2轴角速度、角加速度; i+2 axis angular velocity, angular acceleration;
