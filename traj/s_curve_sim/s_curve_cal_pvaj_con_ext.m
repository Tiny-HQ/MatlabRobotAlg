...
% 连续型，公式计算，无误差； Continuous, formula calculation, no error;
%t t1~8数组； arrary
%j 为jerk；
%t_int 时间间隔  Time interval 
%修改判断条件，在4ms整除情况下，数值的大小无限接近，但并不相等 Modify the judgment condition, in the case of 4ms divisible, the magnitude of the values is infinitely close, but not equal
