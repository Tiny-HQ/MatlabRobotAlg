...
function [s_,v_,a_,jerk_,t_d] = lls_s_curve_all_parameter_cal_traj(t,t_int,j,vs,ss,t_s)
    ...
    %中间过程节点速度; Intermediate process node velocity
    ...
    %中间节点位置; Intermediate node location
