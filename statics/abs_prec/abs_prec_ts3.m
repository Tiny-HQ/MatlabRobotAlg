...
%% 求球心之后与加了工具坐标系之后之间的误差; Find the error between the center of the sphere and the tool coordinate system;
clc;
clear;
format long g;
...
error = error';%这就是带了工具之后，球心与各个点之间的误差 This is the error between the center of the sphere and each point with the tool
%需要error = J*delta_dh解这个方程,delta_dh就是标定之后的每项的误差值; error = J*delta_dh is required to solve this equation, delta_dh is the error value of each term after calibration;
