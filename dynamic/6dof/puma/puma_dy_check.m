...
for i = 1:sum
   ...
   % tao = puma_dy_cal_data(q,dq,ddq);%ţ��ŷ��������;newton-euler method
   %  tao = puma_dy_cal_data_linear_separate(q,dq,ddq);%���Է�����ʽ��;Linear separation form
   
   tao = puma_dy_cal_data_min_param_2(q,dq,ddq);%��С����ʽ��;the min-paramter caculate,tao = puma_dy_cal_data_min_param is also ok, but some paramters is not the same as the book.
