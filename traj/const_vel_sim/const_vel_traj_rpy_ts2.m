...
t = 4.0
no = floor(t/Ts);
[a1,b1,c1,d1] = three_polynomial(A_p(1),A_vel(1),B_p(1),B_vel(1),t);
[a2,b2,c2,d2] = three_polynomial(A_p(2),A_vel(2),B_p(2),B_vel(2),t);
[a3,b3,c3,d3] = three_polynomial(A_p(3),A_vel(3),B_p(3),B_vel(3),t);
