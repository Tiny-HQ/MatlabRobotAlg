...
%������ؽڵ�����ʱ���ҵ�ĳ��ʱ�̶�Ӧ����С�������ľ�����������Щ����ϵ��������U_r�����е�ֵ���ó����ģ�
...
%����ѡȡ���һ�̵�U_r�������(Here we pick the last-minute U_r matrix items)��mx3 = U_r(3,22),my3 = U_r(3,23),xx3 = U_r(3,25),xy3 =
%U_r(3,26),xz3 = U_r(3,27),yz3 = U_r(3,29),zz3 =
%U_r(3,30),Ŀ����Ҫ���M4�ľ���ϵ����Ҳ����U_r(3,31);
...
target = 3.24837371633976;%�����m4���Ӧ�ľ���ϵ��;This is the matrix coefficient corresponding to the m4 term;
W = zeros(35,1);
AA = zeros(10,1);
BB = zeros(10,1);
CC = zeros(10,1);
                ...
                for k = 1:10
                    ...
                    for w = 1:10
                        ...
                        for r = 1:10
                            ...
                            %һ����7�֣���Щ����ܻ�û�У�������2^7�η��֣�ÿһ�ֶ���Ҫ��ѯ����There are 7 kinds in total, and some items may not be available yet, so there are 2^7 power species, and each one needs to be queried
                            for tt = 1:127
                                   %��ż�����һǧ��ξͳ����ˡ����ƻ�ȥ������֪������Щ�Ȼ��������С��������д����Ӧ��ϵ��������,It came out after about 10 million calculations. Push back to know which terms are, and then write the corresponding coefficients into the least squares
                                count = count+1;
