...
DH.theta(6) = 0.0;
 ...
 %q = [130 25 156 -40 20 -90]%(0-180随便填;) (0-180 can be filled in casually; )
q = [0 90 0 0 0 0];%(0-180随便填;) (0-180 can be filled in casually; )
q = [pi/3 pi/2 pi/3 pi/4 pi/5 pi/6]*180/pi;%(0-180随便填;) (0-180 can be filled in casually; )
%q = [0 90 0 0 0 0];%(0-180随便填;) (0-180 can be filled in casually; )
...
% q(2) = q(2)-90;%旋量的初始位置是dh位置负90度; The initial position of the % spin is minus 90 degrees at the DH position;
%q = [92 -36 60 167 35 14]%(0-180随便填;) (0-180 can be filled in casually; )
