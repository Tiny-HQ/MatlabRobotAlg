...
function [Niku,dNiku] = nurbs_cal_basis_functions_Nik_dNik(u,i,k,u_vec)  
...
%optimize
   ...
   if(k == 0)
        ...
        c1 = nurbs_cal_basis_functions(u,i,k-1,u_vec);%(u,i,k,u_vec)  
        c2 = nurbs_cal_basis_functions(u,i+1,k-1,u_vec);%(u,i,k,u_vec)  
        if(i ==0)
