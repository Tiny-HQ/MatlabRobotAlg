...
%% ���ٽ���,��Ⱥ������ⷨ; Uniform feed, Lie Qun Lie algebraic solution; constant velocity
...
Disp = 1000;Vel = 20;Acc = 200;Jerk = 2000; %����������������ɶ���������µ��ٶ����⣬����ǵѿ����ռ䣬����ֻת��̬���ѿ���λ�ò���; The problem here is that the generation is a velocity problem under Lie algebra, if it is a Cartesian space, it can only turn the pose, and the Cartesian position remains the same;
