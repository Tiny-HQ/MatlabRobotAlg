         ...
         for i = 1:sum_no
             if (i*t_int >= 0) && ((i*t_int-t(1))<=0.0000001)
               ...
               elseif (i*t_int-t(3))<=0.0000001
                   ...
                   s(i) =2*w(6)-ww;     %������Ҫע����ǣ��ڼ��������ʱ�򣬼���ǰ��ͼ�����y�Ǵ�1��5����ô������-3��1�ģ�ͼ�����y=1�Գƣ� It should be noted here that when calculating the parameters, if the previous image calculates y from 1 to 5, then here it is -3 to 1, and the image is symmetrical with respect to y=1;
                                        %ͼ���ǹ���y=w(6)�Գƣ�y1+y2 = 2*w(6)�ģ����� The image is about y=w(6) symmetry, y1+y2 = 2*w(6), so
                                        %����һ����ʱ��y1 = 2*w(6)-y2;�滻�õ�s(i) =2*w(6)-ww;    When finding the other, y1 = 2*w(6)-y2; substitution yields s(i) =2*w(6)-ww;   
