...
Px = [0 ;1 ;3;6;10;20 ;25;28;39;45;]; % 控制点坐标  control point coodinate
Py = [10 ;12;2;33;55;20 ;-11;-23;33;52;]; % 控制点坐标  control point coodinate
Wx = [1 ;2;3;4;5;6 ;1 ;4;5;6 ]; % 权重  weight
Wy = [1 ;2;3;4;5 ;10 ;2;3;5;6 ]; % 权重  weight


  
% 定义 NURBS 曲线度数  degeree
k = 3; % 曲线度数  
[m,n] = size(Px);
...
[s] = mnurbs_simpson_cal_length(Ts,last_value,u_vec,k,Px,Wx,Py,Wy)
tic;
