...
for i = 1:lengthq
    ...
    J =  cal_two_link_jacobian_handle(DH,q(:,i)','deg');

%       dv_h(:,i) = cal_two_link_acc_jacobian_handle_v2(q(:,i)',DH,'deg',dq(i)*pi/180*[1 1],ddq(i)*pi/180*[1 1]);
      dv_h(:,i) = cal_two_link_acc_jacobian_handle_v3(q(:,i)',DH,'deg',dq(i)*pi/180*[1 1],ddq(i)*pi/180*[1 1]);
