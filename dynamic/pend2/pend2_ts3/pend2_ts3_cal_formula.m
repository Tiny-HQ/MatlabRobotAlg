...
%����0->3
w00 = [0 0 0]';dw00 = [0 0 0]';v00 = [0 0 0]';dv00 = [0 g 0]';%����дg�Ļ�������gΪ9.81�����д-g����ô����gΪ-9.81;% If you write g here, the variable g is 9.81, and if you write -g, then the variable g is -9.81;
w11 = R10*w00+dq1*zv;
