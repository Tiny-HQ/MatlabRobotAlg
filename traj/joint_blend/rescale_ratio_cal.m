...
%����ģ��; zoom module;
%S�Ǿ��룬����λ��; S is the distance, not the displacement;

function [rescale_ratio,s,v,a,j] = rescale_ratio_cal(S,V,A,J)


    axis_no = length(S);
    MAX_SEG = 7;%�߶μӼ��ٵ��������һ��; the last segment of the array of seven acceleration and deceleration;
    main_axis = -1;%������ main axes number
    main_axis_time = 0.0;%����ʱ��; main axes time;
