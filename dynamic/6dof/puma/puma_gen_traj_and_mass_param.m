...
% -------------------------------------------------------------------------
%生成轨迹和质量参数;generation of trajectories and mass parameters;
%这里必须用修改dh，否则最小集那里有问题;Here you have to modify dh, otherwise there is a problem with the minimum set;
%+---+-----------+-----------+-----------+-----------+-----------+
