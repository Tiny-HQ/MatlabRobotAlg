...
function [Cux,dCux,ddCux,Cuy,dCuy,ddCuy,Cuz,dCuz,ddCuz] = mnurbs_cal_ddcu_derivative(u,k,u_vec,Px,Wix,Py,Wiy,Pz,Wiz)

    [Nik,dNik,ddNik] = mnurbs_cal_basis_func_matrix(u,k,u_vec);
