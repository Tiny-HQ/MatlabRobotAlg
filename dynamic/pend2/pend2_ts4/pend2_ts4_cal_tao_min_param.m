...
function [tao1,tao2] = pend2_ts4_cal_tao_min_param(q11,dq1,ddq1,q22,dq2,ddq2)
    ...
    %����0->3
    w00 = [0 0 0]';dw00 = [0 0 0]';v00 = [0 0 0]';dv00 = [0 0 g]';%����дg�Ļ�������gΪ9.81�����д-g����ô����gΪ-9.81;% If you write g here, the variable g is 9.81, and if you write -g, then the variable g is -9.81;
    zv = [0 0 1]';
    ...
    %min-parameter;
    fi1_min_param = Ii11zz+2*L1*m2*PC22(3)+Ii22yy+L1^2*m2;  %% ZZi_1 = zzi_1+sin^2(��_i)*YYi+2*di*sin^2(��_i)*MZi+(di^2*sin^2(��_i)+ai^2)*Mi
