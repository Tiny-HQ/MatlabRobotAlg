...
%求第一关节力矩时候用;It is used to find the first joint moment;
...
%求第二关节力矩时候用;It is used to find the second joint moment;
...
%可能存在a4、d4、a4^2、d4^2、a4*d4,may exist a4、d4、a4^2、d4^2、a4*d4
A1 = a4*mx2;
A2 = d4*mx2;
A3 = a4^2*mx2;
A4 = d4^2*mx2;
