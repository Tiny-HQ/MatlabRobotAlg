...
for i = 1:sum  
    ...
    %tao = cobot_dy_cal_newton_dynamic(q,dq,ddq);%牛顿欧拉方法求;Newton-Euler method to find
   % tao = cobot_dy_cal_data_linear_separate(q,dq,ddq);
   tao = cobot_dy_cal_data_min_param_2(q,dq,ddq);
    tao1(i) = tao(1);
    tao2(i) = tao(2);
    tao3(i) = tao(3);  
    tao4(i) = tao(4);
