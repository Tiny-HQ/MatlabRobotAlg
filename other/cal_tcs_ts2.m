...
%��ӡԲ������; Print the coordinates of the center of the circle;
[Pc,r] = cal_sphere_center(pos1,pos2,pos3,pos4);



%��һ������ת��xyz; The first point is the transformation xyz;
BB = Pc-pos1(1:3)';
%sqrt(sum(BB.^2))%��֤���İ뾶 Verify the spherical radius
AA = eye(4);
...
T(1:3,4) = V;
AA*T;
%���þ����pʸ������Բ������ The p-vector of the resulting matrix is the center coordinates





%�ڶ�������ת��xyz; The second point is the transformation xyz;
BB = Pc-pos2(1:3)';
%sqrt(sum(BB.^2))%��֤���İ뾶 Verify the spherical radius
...
%����������ת��xyz; The third point is the transformation xyz;
BB = Pc-pos3(1:3)';
%sqrt(sum(BB.^2))%��֤���İ뾶 Verify the spherical radius
...
%���ĸ�����ת��xyz;The fourth point is the transformation xyz;
BB = Pc-pos4(1:3)';
%sqrt(sum(BB.^2))%��֤���İ뾶V erify the spherical radius
