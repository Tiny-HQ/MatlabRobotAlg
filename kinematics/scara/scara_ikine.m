...
function [q] = scara_ikine(T,ori,DH,q_option,alpha_theta_option)
    ...
    theta1 = atan2(py,px);
    theta2 = acos((a2^2-a1^2-pxy2)/(2*a1*pxy2^0.5));%������Ҫע��������(a2^2-a1^2-pxy2)<0��acos�ķ�Χ��[0,180]; It should be noted here that if (a2^2-a1^2-pxy2) < 0, the range of ACOS is [0,180];
    if (a2^2-a1^2-pxy2)<0
        theta2 = pi-theta2;%acos�Լ�����pi������Ҫ����; %acos adds pi itself, so subtract it;
    end
