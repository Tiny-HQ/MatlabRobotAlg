...
% -------------------------------------------------------------------------
%ok;ʵ�ʽ�ģ�����۶�Ӧ; Practical modeling corresponds to theory;
...
%
%
%   ?UE�tu�raeDlLZ?��t�A��C������S��Lt
%   ���z��??
%   Tl��t�AE��z�S�A�S[0 l 0]'
%   N�֤ͨ�?
%   ��EZ�S�AN?E�s�l?
%
...
w_r(1,1) = 0;w_r(1,2) = -a3;w_r(1,3) = a2;%wl?�s�lC�RO?
w_r(2,1) = a3;w_r(2,2) = 0;w_r(2,3) = -a1;
w_r(3,1) = -a2;w_r(3,2) = a1;w_r(3,3) = 0;
w_r;
ew = eye(3)+w_r*s1+w_r*w_r*(1-c1);%ָE�t��TE?;
I = eye(3);
x = cross(w1,v1);
p1 = (I-ew)*x';
T1 = sym(eye(4));
...
w_r(3,1) = -a2;w_r(3,2) = a1;w_r(3,3) = 0;
w_r;
ew = eye(3)+w_r*s2+w_r*w_r*(1-c2);%ָE�t��TE?;
I = eye(3);
x = cross(w2,v2);
p2 = (I-ew)*x';
T2 = sym(eye(4));
...
w_r(3,1) = -a2;w_r(3,2) = a1;w_r(3,3) = 0;
w_r;
ew = eye(3)+w_r*s3+w_r*w_r*(1-c3);%ָE�t��TE?;
I = eye(3);
x = cross(w3,v3);
p3 = (I-ew)*x';
T3 = sym(eye(4));
