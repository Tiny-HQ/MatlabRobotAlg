...
%��scara_dy_fir_test.slx�л�ø����ؽڵķ��������tao��Ȼ���ù켣���ɲ������붯��ѧ��ʽ����õ�tao����������;
...
for i = 1:sum
    ...
    %scara_dy_fir_test.slx�е������ؽ���mm��λ����������ĵ����ؽڶ���1000;scara_dy_fir_test. The third joint in SLX is mm units, so the third joint here is divided by 1000;
