...
function [ddNik] = nurbs_cal_basis_func_sec_dderivative(u,i,k,u_vec)
...
%     dNik = k/length1*nurbs_cal_basis_functions(u,i,k-1,u_vec)-k/length2*nurbs_cal_basis_functions(u,i+1,k-1,u_vec);
    ddNik = k/length1*nurbs_cal_basis_functions_derivative(u,i,k-1,u_vec)-k/length2*nurbs_cal_basis_functions_derivative(u,i+1,k-1,u_vec);
